...
@interface TalentsViewController ()

@end

@implementation TalentsViewController

static NSString *talentsCell=@"talentsCell";
...
- (void)viewDidLoad {
    ...
    // register cell
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:talentsCell];
}
